...
` +
      `Rules:
` +
      `• Reply to tweets naturally — be genuinely helpful, insightful, and conversational.
` +
      `• Keep replies under 240 characters.
` +
      `• Never use hashtags.
` +
      `• Never start with "Great point", "Great take", "So true", or similar generic openers.
` +
